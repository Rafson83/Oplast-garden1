        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-extrabold text-xl tracking-tight text-white font-heading">
                  OPLAST <span className="text-emerald-400">GARDEN</span>
                </span>
            ...
            <div className="pt-2 text-xs text-slate-400 space-y-1 border-t border-slate-800/80">
              <p className="font-bold text-slate-300">Oplast-Recykling Sp. z o.o.</p>
          ...
          <div className="space-y-3 text-xs">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#kratki" className="hover:text-emerald-400 transition-colors">
              ...
              <li>
                <a href="#obrzeza" className="hover:text-emerald-400 transition-colors">
                  Obrzeża Trawnikowe Eko-Bord 45/58/78
                </a>
              </li>
              <li>
                <a href="#akcesoria" className="hover:text-emerald-400 transition-colors">
          ...
          <div className="space-y-3 text-xs">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#montaz" className="hover:text-emerald-400 transition-colors">
                  Instrukcja Montażu Podbudowy
                </a>
              </li>
              <li>
                <a href="#b2b" className="hover:text-emerald-400 transition-colors">
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="space-y-2 text-slate-400">
              <p>
                ...
                <a href="tel:+48537200630" className="text-white font-bold hover:text-emerald-400">
                  +48 537 200 630
                </a>
              </p>
              <p>
                <span className="block text-slate-500">Biuro Obsługi / Detal:</span>
                <a href="tel:+48542371298" className="text-white font-bold hover:text-emerald-400">
                  +48 54 237 12 98
                </a>
              </p>
              <p>
                <span className="block text-slate-500">Adres E-mail:</span>
                <a href="mailto:biuro@oplast-garden.pl" className="text-emerald-400 hover:underline">
